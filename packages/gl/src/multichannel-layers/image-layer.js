...
import { ColorPaletteExtension, isInterleaved, SIGNAL_ABORTED, BitmapLayer } from '@hms-dbmi/viv';
import XRLayer from './xr-layer/xr-layer.js';
 ...
 * @ignore
 */
export default class MultichannelImageLayer extends CompositeLayer {
  finalizeState() {
...
MultichannelImageLayer.layerName = 'MultichannelImageLayer';
MultichannelImageLayer.defaultProps = defaultProps;
