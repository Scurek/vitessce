...
import { getImageSize, isInterleaved, SIGNAL_ABORTED, ColorPaletteExtension } from '@hms-dbmi/viv';

import MultiscaleImageLayerBase from './multiscale-image-layer-base.js';
 ...
 * @ignore
 */
export default class MultichannelMultiscaleImageLayer extends CompositeLayer {
  renderLayers() {
    const {
      loader,
      selections,
    ...
    const baseLayer = implementsGetRaster
      && !excludeBackground
...
MultichannelMultiscaleImageLayer.layerName = 'MultichannelMultiscaleImageLayer';
MultichannelMultiscaleImageLayer.defaultProps = defaultProps;
